...
@section('title', __('my/events/participation.edit_participation.title'))

@section('h1', __('my/events/participation.edit_participation.h1'))
...
@section('content')
    ...
    <form class="registration__form form" @submit.prevent="submit" x-data="{
        ...
        <div class="form__row" id="affiliations" x-data="{
                        ...
                        <label class="form__label" for="f_1">{{ __('my/events/participation.edit_participation.affiliations') }}</label>
							...
							<div class="affiliation form__line" x-data="{
									...
									<div class="input-tips" x-show="show" x-transition.opacity>
										<ul>
											...
											<template x-if="suggestions.length === 0">
												<li>{{ __('my/events/participation.edit_participation.no_suggestions') }}</li>
											</template>
										</ul>
									</div>
									...
									<div class="checkbox-items">
										<div class="checkbox">
											...
											<label :for="'a_1' + id" class="checkbox__label">
												<span class="checkbox__text">{{ __('my/events/participation.edit_participation.affiliation_mistake') }}</span>
											</label>
										</div>
										<div class="checkbox">
											...
											<label :for="'a_2' + id" class="checkbox__label">
												<span class="checkbox__text">{{ __('my/events/participation.edit_participation.no_affiliation') }}</span>
											</label>
										</div>
									</div>
								</div>
								<div class="form__line">
									<button class="form__button button button_outline" type="button" @click="remove(id)">
										{{ __('my/events/participation.edit_participation.remove_affiliation') }}
									</button>
								</div>
							</div>
						</template>
						...
						<div class="form__line">
							<button class="form__button button" type="button" @click="add">{{ __('my/events/participation.edit_participation.add_affiliation') }}</button>
						</div>
                    </div>

        <div class="form__row" :class="form.invalid('orcid_id') && '_error'">
            <label class="form__label" for="c_4">{{ __('my/events/participation.edit_participation.orcid') }}</label>
            <div class="form__line">
        ...
        <div class="form__row" :class="form.invalid('website') && '_error'">
            <label class="form__label" for="c_5">{{ __('my/events/participation.edit_participation.website') }}</label>
            <div class="form__line">
		...
		<div class="form__row" :class="form.invalid('phone') && '_error'">
            <label class="form__label" for="f_10">{{ __('my/events/participation.edit_participation.phone') }}</label>
            <input id="f_10" class="input" autocomplete="off" type="text"
                placeholder="{{ __('my/events/participation.edit_participation.phone') }}" x-model="form.phone"
        ...
        <div class="form__row">
            <label class="form__label">{{ __('my/events/participation.edit_participation.type') }}</label>
            <div class="d-flex-start">
                <div class="checkbox">
                    ...
                    <label for="s_1" class="checkbox__label">
                        <span class="checkbox__text">{{ __('my/events/participation.edit_participation.reporter') }}</span>
                    </label>
                </div>
                <div class="checkbox">
                    ...
                    <label for="s_2" class="checkbox__label">
                        <span class="checkbox__text">{{ __('my/events/participation.edit_participation.visitor') }}</span>
                    </label>
                </div>
                {{-- <div class="checkbox">
        ...
        <div class="form__row">
            ...
            <div class="checkbox">
                ...
                <label for="r_1" class="checkbox__label">
                    <span class="checkbox__text">{{ __('my/events/participation.edit_participation.young_scientist') }}</span>
                </label>
            </div>
        </div>
        ...
        <div class="form__row">
            ...
            <div class="form__btns">
                <button class="form__button button button_primary" :disabled="form.processing" type="submit">
					{{ __('my/events/participation.edit_participation.btn') }}
